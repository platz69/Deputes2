...
SCRUTINS_FOLDER                                     ---  calcul_acteurs_et_votes()   ---> ACTEUR_VOTE_FILE, ACTEURS_FILE

ACTEUR_VOTE_FILE                                    ---  calcul_distances_acteur()          ---> DISTANCES_ACTEUR_ACTEUR_FILE
ACTEUR_VOTE_FILE, ACTEURS_FILE, GROUPES_ABREV_LIBELLE_FILE, TENDANCES_COULEUR_FILE
                                                    ---  calcul_tendance_vote()      ---> TENDANCE_VOTE_FILE
ACTEUR_VOTE_FILE, TENDANCE_VOTE_FILE                ---  calcul_distances_acteurs_tendance() ---> DISTANCES_ACTEUR_TENDANCE_FILE
ACTEURS_FILE                                        ---  charger_fichier_acteur()    ---> {}
ACTEURS_FILE, GROUPES_ABREV_LIBELLE_FILE, TENDANCES_COULEUR_FILE, DISTANCES_ACTEUR_TENDANCE_FILE
